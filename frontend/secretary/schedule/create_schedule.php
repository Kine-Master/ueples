...
<head>
  ...
  <style>
    ...
    .g-cell.occupied {
      background: var(--cell-teacher);
      border-left: 3px solid var(--cell-teacher-b)
    }
    ...
    .g-cell.conflict {
      ...
      border-left: 3px solid var(--cell-conflict-b)
    }
    ...
    .g-cell.preview {
      ...
      border-left: 3px solid var(--cell-preview-b)
    }
...
<body class="page-body">
  ...
  <header class="main-header">
    <div class="brand"><i class="fa-solid fa-calendar-days"></i><span>SECRETARY PORTAL<small class="brand-sub">UEP LES
          System</small></span></div>
    <nav class="top-nav">
      <a href="index.php" class="active"><i class="fa-solid fa-table-cells"></i> <span>Schedules</span></a>
      <a href="../master_data/index.php"><i class="fa-solid fa-database"></i> <span>Master Data</span></a>
      <a href="../profile/index.php"><i class="fa-solid fa-user-circle"></i> <span>Profile</span></a>
      <a href="../../../backend/auth/logout.php" class="btn-logout"><i class="fa-solid fa-right-from-bracket"></i>
        <span>Logout</span></a>
  ...
  <div class="plot-page">
    ...
    <div class="plot-page-hdr">
      <h2><a href="index.php"><i class="fa-solid fa-arrow-left"></i></a> <i class="fa-solid fa-calendar-plus"
          style="color:var(--accent)"></i> New Schedule</h2>
      <div style="font-size:.8rem;color:var(--text-muted)"><i class="fa-solid fa-info-circle"></i> Fill in fields on the
        left � timetable updates live</div>
    </div>
    ...
    <div class="plot-workspace">
      ...
      <div class="acc-panel" id="accPanel">
        ...
        <div class="acc-item" id="acc-room">
          ...
          <div class="acc-body">
            ...
            <div class="form-group" id="grp-room-txt" style="display:none">
              <label class="form-label">Building / Room <span>*</span></label>
              <input type="text" class="form-control" id="fCoedRoomTxt" placeholder="e.g. UEP Main - Room 101"
                oninput="stepCompleted('room')">
            </div>
          </div>
        </div>
        ...
        <!-- 5. LES: Grade, Section, Curriculum, Subject -->
        <div class="acc-item" id="acc-details">
          ...
          <div class="acc-body">
            ...
            <!-- Curriculum -->
            <div class="form-group">
              <label class="form-label" for="fCurriculum">Curriculum <span>*</span></label>
              <select class="form-control" id="fCurriculum" onchange="onCurriculumChange()" disabled>
                <option value="">Select grade first&hellip;</option>
              </select>
            </div>
            <!-- Subject -->
            <div class="form-group">
              ...
              <select class="form-control" id="fSubj" onchange="onSubjectChange(); stepCompleted('subj')" disabled>
                <option value="">Select curriculum first&hellip;</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="acc-item" id="acc-coed-fields" style="display:none">
          ...
          <div class="acc-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="fCoedCourse" placeholder="e.g. BSIT 1-A"
                oninput="stepCompleted('class')">
            </div>
            <div class="form-group">
              <label class="form-label">Subject / Course Name <span>*</span></label>
              <input type="text" class="form-control" id="fCoedSubject" placeholder="e.g. Computer Programming"
                oninput="stepCompleted('subject')">
            </div>
            <div class="form-group">
              <label class="form-label">Units <span>*</span></label>
              <input type="number" step="0.5" min="0.5" class="form-control" id="fCoedUnits" placeholder="e.g. 3"
                oninput="stepCompleted('subject')">
            </div>
          </div>
        </div>
          ...
          <div class="acc-body">
            <div class="form-group">
              ...
              <div style="display:flex;flex-wrap:wrap;gap:8px" id="dayCheckboxes">
                <label class="form-check"><input type="checkbox" value="Monday" onchange="stepCompleted('time')">
                  Mon</label>
                <label class="form-check"><input type="checkbox" value="Tuesday" onchange="stepCompleted('time')">
                  Tue</label>
                <label class="form-check"><input type="checkbox" value="Wednesday" onchange="stepCompleted('time')">
                  Wed</label>
                <label class="form-check"><input type="checkbox" value="Thursday" onchange="stepCompleted('time')">
                  Thu</label>
                <label class="form-check"><input type="checkbox" value="Friday" onchange="stepCompleted('time')">
                  Fri</label>
                <label class="form-check"><input type="checkbox" value="Saturday" onchange="stepCompleted('time')">
                  Sat</label>
              </div>
            </div>
            <div class="form-row">
            ...
            <button class="btn btn-primary" id="saveBtn" onclick="submitSchedule()" disabled
      ...
      <div class="plot-right">
        <div class="plot-legend">
          <span class="legend-item"><span class="legend-dot" style="background:var(--cell-teacher)"></span> Occupied
            Class</span>
          <span class="legend-item"><span class="legend-dot" style="background:var(--cell-conflict)"></span>
            Conflict!</span>
          <span class="legend-item"><span class="legend-dot" style="background:var(--cell-preview)"></span> Proposed
            slot</span>
          <span class="legend-item"><span class="legend-dot"
              style="background:var(--cell-free);border:1px solid var(--border)"></span> Available</span>
        </div>
