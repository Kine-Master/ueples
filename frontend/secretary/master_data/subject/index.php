  ...
  <main class="page-content">
    <div class="page-header">
      <div class="page-header-text">
        <h2><i class="fa-solid fa-book-open" style="color:var(--accent)"></i> Subjects</h2>
        <p>Manage subjects associated with curricula</p>
      </div>
  ...
  <div class="modal-overlay" id="subjModal">
    <div class="modal modal-sm">
      <div class="modal-header">
        <h3 id="modalTitle"><i class="fa-solid fa-plus"></i> Add Subject</h3><button class="modal-close"
          onclick="closeModal('subjModal')"><i class="fa-solid fa-xmark"></i></button>
      </div>
